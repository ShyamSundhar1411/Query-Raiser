...
def approval_mail(self,query):
    ...
    content = ''' Hello {}, Hope you are doing well. This mail is for your acknowledgment that your query {} raised on {}
    has been approved by your respective PR and will be looked upon further.
...
def rejection_mail(self,query):
    ...
    subject = 'Approval Mail - {}'.format(query.title)
    content = ''' Hello {}, Hope you are doing well. This mail is for your acknowledgment that your query {} raised on {}
    has been rejected by your respective PR for certain allegations. We will contact you soon.
    Thank You for your patience.
    Best Regards
    PR Team
    '''.format(query.user.username,query.title,query.date_of_creation)
